      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Full Stack Developer, husband, dog dad, and amateur disc golfer.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Matt, a full stack web developer based out of Austin, TX.
            Welcome to my site.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/melvinioso"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/mattmcgavern/"
